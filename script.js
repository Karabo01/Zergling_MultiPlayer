...
function registerPlayer2() {
  ...
  // Validate player name
  if (playerName2) {
    document.getElementById("btnReg2").style.display = "none";
    // Save player name in local storage
...
function stopRandomAlphabet() {
  ...
  if(cPlayer=='player1')
  {
    localStorage.setItem("pickedLetter",pickedLetter);
  }else{
    console.log("pickedLetter2: "+ pickedLetter);
    localStorage.setItem("pickedLetter2",pickedLetter);
  }
